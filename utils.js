...
const weiboUtils = {
	...
	//图片评论处理
        html = html.replace(/<a href="(.*?)" data-hide="" style="color:#09f!important;text-decoration:none!important;"><br>评论配图 </a>(查看图片 |评论配图 )<\/a>/g,'<a href="$1" style="color:#09f!important;text-decoration:none!important;"> 评论配图 </a><br><br><img src="$1" referrerpolicy="no-referrer" width="400">');
