...
const weiboUtils = {
    formatExtended: (ctx, status, params = {}, picsPrefixes = []) => {
        ...
        const mergedParams = {
            ...
            widthOfPics: fallback(params.widthOfPics, queryToInteger(routeParams.widthOfPics), 800),
        ...
        if (status.retweeted_status) {
            if (readable) {
                ...
                html += `<br><div style="border-left: 3px solid gray; padding-left: 1em;">转发 `;
            }
	...
	//图片评论处理
        html = html.replace(/<a href="(.*?)" data-hide="" style="color:#09f!important;text-decoration:none!important;"><br>(查看图片 |评论配图 )<\/a>/g,'<a href="$1" style="color:#09f!important;text-decoration:none!important;"> 评论配图 </a><br><br><img src="https://images.weserv.nl/?url=$1" referrerpolicy="no-referrer" width="400">');
